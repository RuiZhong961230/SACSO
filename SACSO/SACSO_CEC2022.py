...
def RunSACSO(func):
    ...
    np.savetxt("./SACSO_Data/CEC2022/F" + str(FuncNum) + "_" + str(Dim) + "D.csv", All_Trial, delimiter=",")
...
def main(dim):
    ...
    for i in range(len(CEC2022)):
        FuncNum = i + 1
        RunSACSO(CEC2022[i].evaluate)


if __name__ == "__main__":
    if os.path.exists('./SACSO_Data/CEC2022') == False:
        os.makedirs('./SACSO_Data/CEC2022')
    Dims = [10, 20]
    for Dim in Dims:
        main(Dim)